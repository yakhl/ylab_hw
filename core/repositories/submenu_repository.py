...
from .error_messages import menu_404_msg, submenu_404_msg, submenu_409_msg
...
class SubmenuRepository:
    ...
    def create(self, menu_id: UUID, submenu_data: SubmenuInSchema) -> dict:
        ...
        if (
            ...
            .filter(Submenu.title == submenu_data.title)
            .first()
        ):
...
def add_dishes_counter(submenu: Submenu, db: Session) -> dict:
    return {
